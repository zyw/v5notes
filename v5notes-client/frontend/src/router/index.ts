    ...
    children: [
      {
        ...
        name: 'mdEditor',
        meta: { title: 'Mardown编辑', icon: 'dashboard', affix: true }
      }
    ]
  },
];
...
export const dynamicRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/basics/file-config',
    component: Layout,
    hidden: true,
    permissions: ['basics:fileConfig:list'],
    children: [
      {
        path: 'index',
        component: () => import('@/views/basics/file/config.vue'),
        name: 'OssConfig',
        meta: { title: '配置管理', activeMenu: '/basics/file', icon: '' }
      }
    ]
  },
  {
...
const router = createRouter({
  history: createWebHashHistory(),//createWebHistory(import.meta.env.VITE_APP_CONTEXT_PATH),
