<template>
    <div id="edit-warp" class="w-full">
        <div id="contentVditor" class="md-editor"></div>
    </div>
</template>
<script setup lang="ts">
    import Vditor from 'vditor'
    import "vditor/dist/index.css"
    import { getNotes, updateNotes } from '@/api/notes'
    import { getServerUrl } from '@/utils/commons'
    import { getToken } from '@/utils/auth'
    import { NotesForm, NotesVO } from '@/api/notes/types'
    ...
    const handleSaveContent = async () => {
        const md = contentEditor.value.getValue();
    ...
    const initEditor = () => {
        contentEditor.value = new Vditor('contentVditor', {
            ...
            upload: {
                ...
                url: getServerUrl() + '/basics/base/file',
                linkToImgUrl: getServerUrl() + '/basics/base/file',
                filename (name) {
...
<style lang="scss" scoped>
    ...
    :deep(.save-btn .vditor-tooltipped) {
        padding: 7px 5px;
    }
    :deep(.save-btn .icon) {
        width: 20px;
