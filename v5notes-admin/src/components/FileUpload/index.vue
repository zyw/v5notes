...
import { delFile, listByIds } from '@/api/basics/file';
...
const uploadFileUrl = ref(baseUrl + '/basics/admin/file/upload'); // 上传文件服务器地址
...
const handleDelete = (index: number) => {
  let id = fileList.value[index].id;
  delFile(id);
