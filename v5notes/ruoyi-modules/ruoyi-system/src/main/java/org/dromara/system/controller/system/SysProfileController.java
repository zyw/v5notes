...
public class SysProfileController extends BaseController {
    ...
    public R<AvatarVo> avatar(@RequestPart("avatarfile") MultipartFile avatarfile) throws Exception {
        if (!avatarfile.isEmpty()) {
            ...
            FileInfo fileInfo = upload(avatarfile);
            String avatar = fileInfo.getUrl();
            if (userService.updateUserAvatar(LoginHelper.getUserId(), fileInfo.getId())) {
    ...
    private FileInfo upload(MultipartFile file) throws Exception {
        return fileInfoService.uploadByBo(file.getName(),null, file.getBytes());
    }
}
